...
namespace Hook {
    ...
    static DWORD64 ClientViewAnglesAddress = 0;
    ...
    static void UpdateThread() {
        ...
        while (isRunning) {
            ...
            DWORD64 client_view_angles_base = moduleBase + Offset::ClientViewAngles::MODULE_OFFSET;
            auto [client_view_angles_address, client_view_angles_success] = PointerScanner::Scan(client_view_angles_base, Offset::ClientViewAngles::OFFSETS, debugSteps);
            ClientViewAnglesAddress = client_view_angles_success ? client_view_angles_address : 0;
        }
    }
    ...
    DWORD64 GetClientViewAnglesAddress() {
        return ClientViewAnglesAddress;
    }
}