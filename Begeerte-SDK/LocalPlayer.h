...
namespace LocalPlayer {
    struct Player {
        ...
        byte padding_3;        // Unknown
        byte padding_4;        // Unknown
        byte padding_5;        // Unknown
        byte padding_6;        // Unknown
        byte padding_7;        // Unknown
        byte padding_8;        // Unknown
