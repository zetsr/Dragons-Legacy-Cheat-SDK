...
namespace Cheat {
    ...
    static void CheatThread() {
        Logs::LogManager::Thread();
        Radar::RadarManager::Thread();

        while (isRunning) {
            UpdateThread(); // 更新所有地址
            EntityList::Update();
            Radar::RadarManager::s_instance->UpdateRadar(g_cheatdata->LocalCameraPosition, g_cheatdata->LocalPlayer);
            ...
            */
            ...
            // Aimbot::Aimbot::LegitBot();
            Aimbot::Aimbot::TriggerBot();
            ...
            */
            ...
            /* 
            * 也许应该放在其他地方，比如所有检查之前的头部，然后让对应的模块自己处理检查。
            EntityList::Update();
            Radar::RadarManager::s_instance->UpdateRadar(g_cheatdata->LocalCameraPosition, local_player);
            */
